...
<img src="/paw.webp" alt="PocketPaw mascot" width="180" style="display:block;margin:0 auto 1.5rem;" />
...
<CardGroup>
  ...
  <Card title="3 Agent Backends" icon="lucide:cpu" href="/backends">
    Claude Agent SDK, PocketPaw Native, or Open Interpreter. Pick the engine that suits your needs.
  </Card>
